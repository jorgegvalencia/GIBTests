...
import gov.nih.nlm.nls.metamap.uima.ts.MatchMap;
...
public class UIMASampleApp {
	   ...
	   java.io.IOException
  {
	...
	new XMLInputSource(System.getProperty("analysis.engine.descriptor",
					      "C:/Users/Jorge/public_mm/src/uima/desc/MetaMapApiAE.xml"));
	   ...
	   java.io.IOException
  {
    ...
    String doc1 = "Non-metastatic primary invasive HER2-positive carcinoma of the breast that is adequately excised and that is node-positive (except T0).";
